...
from networks.SCFG_Net import SCFG_Net
...
#     "--val_path",
#     type=str,
#     default="../data/Acdc/validation_vol_h5",
#     help="root dir for val data",
# )
parser.add_argument("--dataset", type=str, default="Synapse", help="experiment_name")
parser.add_argument("--list_dir", type=str, default="./lists/lists_Synapse", help="list dir")
parser.add_argument("--num_classes", type=int, default=9, help="output channel of network")
parser.add_argument("--output_dir", type=str, default="./model_out/scfg_blcok_femmaxavg", help="output dir")
...
parser.add_argument("--batch_size", type=int, default=16, help="batch_size per gpu")  # default = 24
parser.add_argument("--num_workers", type=int, default=4, help="num_workers")
parser.add_argument("--eval_interval", type=int, default=20, help="eval_interval")
parser.add_argument("--model_name", type=str, default="SCFG_Net", help="model_name")
...
parser.add_argument('--resume_checkpoint', action='store_true', help="Resume training from a checkpoint if available")
...
if __name__ == "__main__":
    ...
    net = SCFG_Net(num_classes=args.num_classes).cuda(0)
